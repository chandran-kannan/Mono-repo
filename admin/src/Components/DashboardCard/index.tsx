...
function DashboardCard() {
  return (
    <section className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 w-full max-w-6xl h-[140px] ">
      ...
      <div className="relative p-5 bg-gradient-to-r from-blue-400 to-blue-600 rounded-md overflow-hidden">
        ...
        <div className="relative z-10 text-blue-200 leading-none font-semibold">
          car
        </div>
        <svg
          fill="none"
      ...
      <div className="relative p-5 bg-gradient-to-r from-red-400 to-red-600 rounded-md overflow-hidden">
        ...
        <div className="relative z-10 text-red-200 leading-none font-semibold">
          car enquiry
        </div>
        <svg
          fill="none"
      ...
      <div className="relative p-5 bg-gradient-to-r from-yellow-400 to-yellow-600 rounded-md overflow-hidden">
        <div className=" mb-4 text-white text-4xl leading-none font-semibold">
          97
        </div>
        <div className="text-yellow-200 leading-none font-semibold">
          Loan enquiry
        </div>
        <svg
          fill="none"
